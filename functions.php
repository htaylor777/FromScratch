...
function fromScratch_custom_logo_setup() {
    $defaults = array(
        'height'               => 100,
        'width'                => 400,
        'flex-height'          => true,
...
add_action( 'after_setup_theme', 'fromScratch_custom_logo_setup' );
 ...
 * Add a sidebar.
 */
function fromscratch_theme_slug_widgets_init() {
    register_sidebar( array(
        'name'          => __( 'Main Sidebar', 'fromscratch' ),
        'id'            => 'sidebar',
        'description'   => __( 'Widgets in this area will be shown on all posts and pages.', 'fromscratch' ),
...
add_action( 'widgets_init', 'fromscratch_theme_slug_widgets_init' );
